  ...
  'admission/tuition-and-fees': {
    ...
    blocks: [
      ...
      },
      {
        ...
        note: 'Tuition, Athletics, and Room & Board are confirmed for the 2026–2027 school year. Remaining items will be published here as they are finalized — request the current schedule from the admission office in the meantime.',
      },
      {
        type: 'features',
        heading: 'What’s included',
        items: [
          { title: 'Tuition', text: 'Academics, study hall, tutoring, and academic advising.' },
          { title: 'Athletics', text: 'All sport sessions with the full coaching staff, the performance program, and 5-to-1 recruiting support.' },
          { title: 'Room & Board', text: 'Residence and the athlete nutrition program.' },
          { title: 'Campus activities', text: 'Weekend activities and service programming, included at no additional cost.' },
        ],
      },
      {
        type: 'faq',
