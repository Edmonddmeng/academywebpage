  ...
  'admission/tuition-and-fees': {
    ...
    blocks: [
      ...
      },
      {
        ...
        note: '学费、体育训练费与食宿费已确认为2026–2027学年费用。其余项目金额将在确定后于此公布——在此之前,可向招生办公室索取当前费用清单。',
      },
      {
        type: 'features',
        heading: '费用包含内容',
        items: [
          { title: '学费', text: '课程、自习厅、辅导与学术指导。' },
          { title: '体育训练费', text: '完整教练团队提供的全部专项训练课、体能项目,以及5比1招募支持。' },
          { title: '食宿费', text: '住宿与运动员营养餐饮项目。' },
          { title: '校园活动', text: '周末活动与公益服务项目,不另收费。' },
        ],
      },
      {
        type: 'faq',
