  ...
  'about/campuses': {
    ...
    blocks: [
      ...
      },
      {
        ...
        paragraphs: [
          '位于南加州橙县 San Juan Capistrano 的 Capistrano Valley Christian Schools(CVCS),是一所具有鲜明美国私立学校特色的基督教大学预备制学校,为学生提供从幼儿园至高中的连续教育。学校以基督教信仰为教育基础,重视学术发展、品格培养、体育、艺术、领导力以及学生的全面成长,同样重视诚信、责任、自律、尊重与服务他人的意识。',
          'CVCS是一个真实的美国私立学校社区,而非围绕国际学生设置的教育环境。我们的学生能够与不同背景的同龄人建立关系,提升英语沟通能力,并真正体验美国校园生活——日常课堂、校园传统、体育、艺术与社区生活。对于希望孩子不仅仅是在美国上课,而是真正体验美国学校的家庭而言,这种校园经历具有重要意义。',
          'JMC Academy选择与CVCS建立合作,是因为我们相信,学生的成长不仅来自课堂上的知识,也来自他们每天所处的校园环境、所建立的人际关系,以及在学习、体育和日常生活中承担的责任。CVCS负责学生的正式学校教育和校园学习体验,而JMC Academy则在学校教育之外,为学生提供个性化的学业辅导、竞技体育训练、学生生活管理、家庭沟通及长期发展规划。',
        ],
      },
      {
        type: 'gallery',
      ...
      },
      {
        ...
        paragraphs: [
          '位于加州San Diego的Maranatha Christian Schools(MCS),是一所将基督教信仰与学术教育、艺术、体育及学生个人发展相结合的私立学校。学校致力于为学生提供具有明确教育理念的学习社区,帮助他们建立扎实的学术基础、探索自身兴趣,并为未来的大学教育和人生道路做好准备,同时重视诚信、尊重、责任、服务与人与人之间的关怀。',
          ...
          'JMC Academy与MCS的合作理念,建立在对学生全面发展的共同重视之上。MCS负责学生在学校内的正式学术教育与校园体验,JMC Academy则围绕学生的个人目标,提供课后学习辅导、竞技体育训练、学生生活管理、家庭沟通以及长期学生运动员发展规划。',
        ],
      },
      {
        type: 'image',
