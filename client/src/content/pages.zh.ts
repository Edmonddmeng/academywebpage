...
export const pageContentZh: Record<string, PageContent> = {
  ...
  'about/mission-and-vision': {
    ...
    blocks: [
      {
        type: 'statement',
        text: 'JMC致力于为具有体育潜力和长期发展目标的青少年学生运动员,建立专业、系统、可持续的发展体系,帮助每一位学生在学术、竞技、身体素质、自我管理与个人品格等方面同步成长。',
        attribution: '我们的使命',
      },
      {
        type: 'prose',
        paragraphs: [
          '大多数学生运动员被迫做出选择:要么认真训练、放松学业,要么保住成绩单、只用剩余时间训练。我们认为这种取舍是设计上的失败,而不是必然的现实。因此,每一位加入JMC的学生都会获得一份专属的 Student-Athlete Development Plan(学生运动员发展计划)——根据年龄、学术背景、竞技水平、身体发展情况及长期目标量身制定——并由一位专属 Student-Athlete Manager 负责统筹协调其学业、训练、赛事与升学路径,让这些原本分散的环节成为一套连续的计划,而不是四场各自独立的对话。',
          '这份计划将伴随学生从入学第一学期,一路延续到大学录取:学术规划与NCAA资格管理、竞技发展与赛事安排、体能训练与恢复、住宿生活,以及最终的大学体育招募与升学支持。一个学生,一套计划,一支团队对全程负责。',
        ],
      },
      {
        type: 'numbered',
        ...
        items: [
          ...
          {
            title: '诚实胜过夸大',
            text: '我们不会承诺任何学生必然进入某所学校、大学或职业球队。我们所承诺的,是专业的规划、持续的跟进,以及一个真正准备好的学生。',
          },
          {
            title: '关注,而非规模',
