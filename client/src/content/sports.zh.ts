...
export const kinds: Record<SportKind, KindDetails> = {
  ...
  fencing: {
    ...
    intro: (title) =>
      `${title}是我们最新设立的项目，专为冲击全国资格赛与大学体育特招而打造。击剑运动员在专属教练团队带领下每日训练，并按所选剑种制定个人计划，涵盖步伐、剑法、战术与比赛策略。`,
    detail:
    ...
    focus: ['步伐与距离感', '按剑种的剑法训练', '比赛战术与策略', '录像分析', '力量与爆发力', '灵活性与恢复'],
    week: [
      { day: '周一', morning: '力量训练', afternoon: '步伐与剑法训练' },
      { day: '周二', morning: '步伐与体能训练', afternoon: '实战对抗训练' },
      { day: '周三', morning: '力量训练', afternoon: '步伐与剑法训练' },
      { day: '周四', morning: '灵活性与恢复', afternoon: '实战对抗训练' },
      { day: '周五', morning: '赛前激活', afternoon: '比赛或训练' },
      { day: '周六', morning: '比赛日', afternoon: '恢复' },
      { day: '周日', morning: '休息', afternoon: '休息' },
    ],
    recruiting:
      '每位击剑运动员都由运动员招募专员、教练、学术顾问、学生事务助理与家庭顾问共同支持，他们协作制定招募规划、准备比赛录像、主动联系大学教练，并指导家庭理解NCAA规则与录取通知。',
  },
}
